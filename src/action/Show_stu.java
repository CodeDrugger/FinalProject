...
public class Show_stu implements Action {
	...
	public String Attention_on_stu(){//需要传参数 tea.attentioned_me stu_select.attentioned_tea teas.id teas.name stu_selected.id name 
	      ...
	      rate++;
	      rates=rate+"";
	      String stu_beiguan = stus.getAttentioned_me()+"/"+tea_select.getId();
	      //格式 /name id 0:待定 1:同一 2:不同意
	      String tea_guan = tea_select.getAttentioned_stu()+"/"+stus.getId();
	      ...
	      if(tea_select.getAttentioned_stu().contains(stus.getId()))
	      {
	    	  message="已经关注了该学生";
	    	  return "has_selected";
	      }
