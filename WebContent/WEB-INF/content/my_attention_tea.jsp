  ...
  <div class="three wide column">
    <div class="ui massive pointing vertical menu">
      <div class="ui item">
        ...
        <a class="active item" href="./my_attention_tea?id_in=${id}"><i class="attach icon"></i>我关注的</a>
        <a class="item" href="./attention_me_tea?id_in=${id}"><i class="attach icon"></i>关注我的</a>
      </div>
      <div class="item">
  ...
  <div class="six wide stretched column">
    <div class="ui segment">
      <div class="ui divided items">
        <s:iterator value="attention_tea" var="am">
        <div class="item">
          <div class="ui small image">
            <img src="./images/elyse.png">
          </div>
          <div class="content">
            <a class="header" href="Mytea_inf.action?tea_inf_id=${at.id}&id_in=${id_in}">${at.name}</a>
            <div class="meta">
              <span>个人简介</span>
            </div>
