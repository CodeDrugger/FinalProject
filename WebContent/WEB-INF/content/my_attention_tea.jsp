...
<div class="container">
  <h2 style="margin-bottom: 5%;">我关注的导师</h2>
  <div class="row">
    <s:iterator value="attention_tea" var="at">
    <div class="col-md-3 ">
      <div class="panel card">
        <div class="panel-body">
          <div class="incard">导师姓名：<a href="Mytea_inf.action?tea_inf_id=${at.id}&id_in=${id_in}">${at.name}</a></div>
          <div class="incard">个人简介：${at.self_intro}</div>
          <div class="incard">
            <form name="form3" method="post" action="Choose_tea">
