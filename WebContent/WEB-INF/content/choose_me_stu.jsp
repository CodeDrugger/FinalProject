  ...
  <div class="three wide column">
    <div class="ui massive pointing vertical menu">
      ...
      <div class="item">
        ...
        <a class="item"><i class="attach icon" href="./my_choose_stu?id_in=${id}"></i>我选择的</a>
        <a class="active item"><i class="attach icon" href="./choose_me_stu?id_in=${id}"></i>选择我的</a>
      </div>
    </div>
  </div>
            ...
            <div class="content">
              ...
              <div class="ui extra">
                ...
                <form name="form3" method="post" action="Tea_cancel_attention">
                  <input type="hidden"  name="teacher_id" value="${id_in}" />
                  <input type="hidden"  name="student_id" value="${sm.id}" />
                  <button type = "submit" class="ui right floated grey button" onclick="javascript:form.submit();">
                    取关TA
                  <i class="right chevron icon"></i>
                 </button>
                </form>
