...
<nav class="navbar navbar-default navopa navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="container">
      <h2 style="margin-bottom: 5%;">关注我的学生</h2>
      <div class="row">
        <s:iterator value="attention_me" var="am">
          <div class="col-md-3 ">
            <div class="panel card">
              <div class="panel-body">
                <div class="incard">学生姓名：<a href="Mystu_inf.action?stu_inf_id=${am.id}&id_in=${id_in}">${am.name}</a><br/></div>
                <div class="incard">个人简介：${am.self_intro}<br/></div>
                <div class="incard"><form name="form4" method="post" action="Attention_stu">
