  ...
  <div class="three wide column">
    ...
    <div class="ui massive pointing vertical menu">
      ...
      <div class="item">
        ...
        <a class="active item"><i class="attach icon" href="./my_choose_stu?id_in=${id}"></i>我选择的</a>
        <a class="item"><i class="attach icon" href="./choose_me_stu?id_in=${id}"></i>选择我的</a>
      </div>
    </div>
  </div>
  <!--the student-->
      ...
      <div class="ui divided items">
        <s:iterator value="select_stu" var="st">
          <div class="item">
            ...
            <div class="content">
              <a class="header" href="Mystu_inf.action?stu_inf_id=${st.id}&id_in=${id_in}">${st.name}</a>
              <div class="meta">
                <span>个人简介</span>
              </div>
              ...
              <div class="ui extra">
                you have choose this student,please contact with each other
              </div>
            </div>
          </div>
        </s:iterator>
