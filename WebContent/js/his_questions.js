window.onload=function()
{
	...
	else
	{
		for (var i = 1; i <= amount; i++)
		{
			...
			div_block.innerHTML = "<div class=\"ui segment\">" +
					"问题" + i + ":<input style=\"border: none;\" name=\"a.questions\" value=\""+ array[i-1] +"\" readonly=\"readonly\">" +
							"<textarea rows=\"5\" name=\"a.answers\">"+ans[i-1]+"</textarea></div>";
